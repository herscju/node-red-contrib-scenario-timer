...
class Generator {
    ...
    setMaxNumber(maxNumber) {
        this.maxNumber = maxNumber || Indicator.INDICATORS.length;
    ...
    setMinOnTime(minOnTime) {
        this.minOnTime = minOnTime || this.minOnTime;
    ...
    init() {
        ...
        this.observers = Array.from(arguments)
        this.observers.forEach(observer => this.subject.subscribe(observer));
        ...
        this.timer.init.apply(this.timer, this.observers);
        ...
        this.addTask(() => {
            ...
            if (!this.controller.signal.aborted) {
                ...
                Timer.wait(wait, this.controller.signal.aborted, timerId).then((timerId) => {
                    this.generate(this.date, timerId);
