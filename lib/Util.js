...
class Util {
    ...
    /**
     * A reliable way to detect Node and Browser environments.
     * 
     * See 'https://stackoverflow.com/a/77033584/6487382'
     * 
     * @returns 
     */
    static isBrowser() {
     ...
     * 
     * See 'https://bobbyhadz.com/blog/javascript-check-if-value-is-object'
     * 
     * @param {*} value 
     * @returns 
     */
    ...
    /**
     * Check if a value is number in JavaScript.
     * 
     * See 'https://byby.dev/js-check-number'
     * 
     * @param {*} value 
     * @returns 
     */
    ...
    /**
     * Generate UUID by input or random.
     * 
     * @param {*} str 
     * @returns 
     */
